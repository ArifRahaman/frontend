  ...
  return (
    <>
      <div className="bg-gray-100 font-sans">
        <div className="text-black py-20 shadow-lg bg-gradient-to-r from-blue-300 to-indigo-300 bg-opacity-50">
          ...
          <div className="flex flex-wrap -m-4 ">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 justify-center gap-8 items-center mt-32 mx-auto max-w-screen-2xl">
              {doctors.map((item, idx) => (
                <div key={item._id} className="product max-w-2xl overflow-hidden shadow-lg flex flex-col h-full group hover:transition duration-300 transform hover:-translate-y-2 hover:shadow-xl mb-8 mx-4 rounded-xl">
