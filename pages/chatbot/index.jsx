        ...
        <div className="container px-5 py-24 mx-auto">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full h-10 bg-opacity-50 rounded border border-gray-900 text-base outline-none text-black py-1 px-3 leading-8 transition-colors duration-200 ease-in-out mt-10"
              value={inputText}
          ...
          <input
            className="flex mx-auto  text-white bg-blue-900 border-0 py-2 px-4 focus:outline-none hover:bg-indigo-600 rounded text-lg mt-2 cursor-pointer"
