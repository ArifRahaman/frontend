...
const Faqs = () => {
  const faqs = [
    ...
    {
      question: "How can I get premium subscription ?",
      answer:
        "Go to the subscription option in user(patient) dashboard and  select premium membership",
    },
    {
    ...
    {
      question: "If I have any doubt regarding this website how can I reach out?",
      answer:
        "Please go to the home page and contact us using your own email address",
    },
